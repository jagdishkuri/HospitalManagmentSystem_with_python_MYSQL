...
#DataframeLeft
       ...
       #presecription
        ...
        btnpresecriptionData = Button(Buttonframe, text="Prescription Data",bg ="green",fg="white", font=("arial",12,"bold"),width=23,padx=2, pady=6)
    ...
    def iPrescriptionData(self):
        if self.nameoftablets.get()=="" or self.ref.get()=="":
          messagebox.showerror("error", "all fields are required")
            ...
            conn= mysql.connector(host = "localhost", username = "root", passwords = "Jaggu@905796" , database = "student")
